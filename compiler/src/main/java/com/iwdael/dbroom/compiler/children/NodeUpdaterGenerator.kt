 ...
 */
class NodeUpdaterGenerator(private val clazz: Class, private val env: RoundEnvironment) {
    fun typeSpec(): TypeSpec {
        return TypeSpec.classBuilder(clazz.updaterClassName().simpleName())
                    ...
                    .map {
                        ...
                        MethodSpec.methodBuilder("where")
                            ...
                            .addStatement(
                                ...
                                it.whereClassName(env), clazz.updateOperator(), type, clazz.updateOperator(),
                            )
                            .returns(
                                ParameterizedTypeName.get(
