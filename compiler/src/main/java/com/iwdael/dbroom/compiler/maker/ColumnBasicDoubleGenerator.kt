 ...
 */
class ColumnBasicDoubleGenerator : Generator {
    override fun classFull() = "${packageName()}.${simpleClassName()}"
    override fun simpleClassName() = BASIC_DOUBLE_COLUMN.simpleName()
    override fun packageName() = BASIC_DOUBLE_COLUMN.packageName()

    override fun generate(filer: Filer) {
        JavaFile
            .builder(
                packageName(), TypeSpec.classBuilder(simpleClassName())
                    .superclass(ParameterizedTypeName.get(BASIC_COLUMN, DOUBLE_PACKING))
