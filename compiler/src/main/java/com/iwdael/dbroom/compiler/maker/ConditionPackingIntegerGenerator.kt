...
import com.iwdael.dbroom.compiler.JavaClass.CONDITION_INTEGER_PACKING
 ...
 */
class ConditionPackingIntegerGenerator : Generator {
    override val simpleClassNameGen: String = CONDITION_INTEGER_PACKING.simpleName()
    override val packageNameGen: String = CONDITION_INTEGER_PACKING.packageName()
