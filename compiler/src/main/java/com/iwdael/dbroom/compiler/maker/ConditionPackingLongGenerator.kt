...
import com.iwdael.dbroom.compiler.JavaClass.CONDITION_LONG_PACKING
...
class ConditionPackingLongGenerator : Generator {
    override val simpleClassNameGen: String = CONDITION_LONG_PACKING.simpleName()
    override val packageNameGen: String = CONDITION_LONG_PACKING.packageName()
