...
import com.iwdael.dbroom.compiler.JavaClass.CONDITION_BOOLEAN_PACKING
...
class ConditionPackingBooleanGenerator : Generator {
    override val simpleClassNameGen: String = CONDITION_BOOLEAN_PACKING.simpleName()
    override val packageNameGen: String = CONDITION_BOOLEAN_PACKING.packageName()
