 ...
 */
class NodeDeleterGenerator(private val clazz: Class, private val env: RoundEnvironment) {
    fun typeSpec(): TypeSpec {
        return TypeSpec.classBuilder(clazz.deleterClassName().simpleName())
                    ...
                    .map {
                        ...
                        MethodSpec.methodBuilder("where")
                            ...
                            .addStatement(
                                ...
                                it.whereClassName(env), clazz.deleteOperator(), type, clazz.deleteOperator(),
                            )
                            .returns(
                                ParameterizedTypeName.get(
