...
fun Field.isCommonColumn(): Boolean {
    return when (asTypeName()) {
        TypeName.BOOLEAN -> true
        JavaClass.BOOLEAN_PACKING -> true
        TypeName.BYTE -> true
        JavaClass.BYTE_PACKING -> true
        TypeName.CHAR -> true
        JavaClass.CHAR_PACKING -> true
        TypeName.DOUBLE -> true
        JavaClass.DOUBLE_PACKING -> true
        TypeName.FLOAT -> true
        JavaClass.FLOAT_PACKING -> true
        TypeName.INT -> true
        JavaClass.INT_PACKING -> true
        TypeName.LONG -> true
        JavaClass.LONG_PACKING -> true
        TypeName.SHORT -> true
        JavaClass.SHORT_PACKING -> true
        ClassName.get(String::class.java) -> true
        else -> false
    }
}
