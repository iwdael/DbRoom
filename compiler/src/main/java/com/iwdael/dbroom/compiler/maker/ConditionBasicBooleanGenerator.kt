...
import com.iwdael.dbroom.compiler.JavaClass.CONDITION_BOOLEAN_BASIC
 ...
 */
class ConditionBasicBooleanGenerator : Generator {
    override val simpleClassNameGen: String = CONDITION_BOOLEAN_BASIC.simpleName()
    override val packageNameGen: String = CONDITION_BOOLEAN_BASIC.packageName()
