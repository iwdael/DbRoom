...
import com.iwdael.dbroom.compiler.JavaClass.CONDITION_SHORT_PACKING
 ...
 */
class ConditionPackingShortGenerator : Generator {
    override val simpleClassNameGen: String = CONDITION_SHORT_PACKING.simpleName()
    override val packageNameGen: String = CONDITION_SHORT_PACKING.packageName()
                ...
                packageNameGen, TypeSpec.classBuilder(simpleClassNameGen)
                    ...
                    .addMethod(
                        MethodSpec.methodBuilder("equal")
                            .addModifiers(Modifier.PUBLIC)
                            .addParameter(SHORT_PACKING, "value")
                    ...
                    .addMethod(
                        MethodSpec.methodBuilder("between")
                            .addModifiers(Modifier.PUBLIC)
                            .addParameter(SHORT_PACKING, "value1")
                            .addParameter(SHORT_PACKING, "value2")
                    ...
                    .addMethod(
                        MethodSpec.methodBuilder("in")
                            .addModifiers(Modifier.PUBLIC)
                            .addParameter(ArrayTypeName.of(SHORT_PACKING), "value")
                            .varargs()
                            .addStatement(
