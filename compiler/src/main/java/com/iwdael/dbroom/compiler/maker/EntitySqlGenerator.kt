...
class EntitySqlGenerator(private val env: RoundEnvironment, private val clazz: Class) : Generator {
        ...
        JavaFile
            .builder(
                packageNameGen, TypeSpec.classBuilder(simpleClassNameGen)
                    ...
                    .addMethod(
                        MethodSpec.methodBuilder("newReplacer")
                            .addModifiers(Modifier.STATIC, Modifier.PUBLIC)
                            .addStatement("return new \$T()", clazz.sqlReplacerBuilderClassName())
                            .returns(clazz.sqlReplacerBuilderClassName())
                            .build()
                    )
                    ...
                    .addType(createSQLTypeSpec2(clazz.sqlReplacerClassName()))
        ...
        return TypeSpec.classBuilder(clazz.sqlUpdaterBuilderClassName())
                ...
                clazz.roomFields()
                    ...
                    .map {
                        MethodSpec.methodBuilder("appending")
                            ...
                            .apply {
                                if (it.isCommonColumn()) {
                                    addStatement("columns.put(column, field)")
                                } else {
                                    val method = it.convertType(env)!!.second
                                    addStatement("columns.put(column, \$T.${method.name}(field))", method.parent.asTypeName())
                                }
                            }
            ...
            .addMethod(
                MethodSpec.methodBuilder("toBindArgs")
                    .addModifiers(Modifier.PRIVATE)
                    .returns(ArrayTypeName.of(Object::class.java))
                    .addStatement("return \$T.toBindArgs(columns, wheres)", UTILS)
                    .build()
            )
            .build()
    }

    private fun replacerBuilder(): TypeSpec {
        return TypeSpec.classBuilder(clazz.sqlReplacerBuilderClassName())
            .addModifiers(Modifier.STATIC, Modifier.FINAL, Modifier.PUBLIC)
            .addField(
                FieldSpec.builder(
                    ParameterizedTypeName.get(
                ...
                clazz.roomFields()
                    ...
                    .map {
                        MethodSpec.methodBuilder("appended")
                            ...
                            .returns(
                                ParameterizedTypeName.get(
                                    clazz.replacerClassName(),
                                    ParameterizedTypeName.get(
                                        clazz.replacerClassName(),
                                        TypeVariableName.get("?"),
                                        clazz.sqlReplacerBuilderClassName(),
                                        clazz.sqlReplacerClassName()
                                    ),
                                    clazz.sqlReplacerBuilderClassName(),
                                    clazz.sqlReplacerClassName()
                                )
                            ...
                            .addStatement(
                                "return new \$T<>(this, wheres::add, \$T::new, builder -> new \$T(builder.toUpdaterSelection(), builder.toUpdaterBindArgs(), builder.toInserterSelection(), builder.toInserterBindArgs(), builder.toFinderSelection(), builder.toFinderBindArgs()))",
                                clazz.replacerClassName(),
                                clazz.replacerClassName(),
                                clazz.sqlReplacerClassName()
                            )
            ...
            .addMethod(
                MethodSpec.methodBuilder("toUpdaterSelection")
                    .addModifiers(Modifier.PRIVATE)
                    .returns(String::class.java)
                    .addStatement(
                        "return \$T.toUpdaterSelection(\"${clazz.roomTableName()}\", columns, wheres)",
            ...
            .addMethod(
                MethodSpec.methodBuilder("toUpdaterBindArgs")
                    .addModifiers(Modifier.PRIVATE)
                    .returns(ArrayTypeName.of(Object::class.java))
                    .addStatement("return \$T.toBindArgs(columns, wheres)", UTILS)
                    .build()
            ...
            .addMethod(
                MethodSpec.methodBuilder("toInserterSelection")
                    .addModifiers(Modifier.PRIVATE)
                    .returns(String::class.java)
                    .addStatement(
            ...
            .addMethod(
                MethodSpec.methodBuilder("toInserterBindArgs")
                    .addModifiers(Modifier.PRIVATE)
                    .returns(ArrayTypeName.of(Object::class.java))
            ...
            .addMethod(
                MethodSpec.methodBuilder("toFinderSelection")
                    .addModifiers(Modifier.PRIVATE)
                    .returns(String::class.java)
                    .addStatement(
                        "return \$T.toFinderSelection(\"${clazz.roomTableName()}\", new Object[]{}, wheres)",
                        UTILS
                    )
                    .build()
            )
            .addMethod(
                MethodSpec.methodBuilder("toFinderBindArgs")
                    .addModifiers(Modifier.PRIVATE)
                    .returns(ArrayTypeName.of(Object::class.java))
                    .addStatement("return \$T.toBindArgs(wheres)", UTILS)
                    .build()
    ...
    private fun createSQLTypeSpec2(clazzName: ClassName): TypeSpec {
        return TypeSpec.classBuilder(clazzName)
            .addModifiers(Modifier.PUBLIC, Modifier.FINAL, Modifier.STATIC)
            .addField(
                FieldSpec.builder(String::class.java, "updateSelection")
                    .addModifiers(Modifier.FINAL, Modifier.PUBLIC)
                    .build()
            )
            .addField(
                FieldSpec.builder(ArrayTypeName.of(Object::class.java), "updateBindArgs")
                    .addModifiers(Modifier.FINAL, Modifier.PUBLIC)
                    .build()
            )
            .addField(
                FieldSpec.builder(String::class.java, "insertSelection")
                    .addModifiers(Modifier.FINAL, Modifier.PUBLIC)
                    .build()
            )
            .addField(
                FieldSpec.builder(ArrayTypeName.of(Object::class.java), "insertBindArgs")
                    .addModifiers(Modifier.FINAL, Modifier.PUBLIC)
                    .build()
            )
            .addField(
                FieldSpec.builder(String::class.java, "findSelection")
                    .addModifiers(Modifier.FINAL, Modifier.PUBLIC)
                    .build()
            )
            .addField(
                FieldSpec.builder(ArrayTypeName.of(Object::class.java), "findBindArgs")
                    .addModifiers(Modifier.FINAL, Modifier.PUBLIC)
                    .build()
            )
            .addMethod(
                MethodSpec.constructorBuilder()
                    .addModifiers(Modifier.PRIVATE)
                    .addParameter(String::class.java, "updateSelection")
                    .addParameter(ArrayTypeName.of(Object::class.java), "updateBindArgs")
                    .addParameter(String::class.java, "insertSelection")
                    .addParameter(ArrayTypeName.of(Object::class.java), "insertBindArgs")
                    .addParameter(String::class.java, "findSelection")
                    .addParameter(ArrayTypeName.of(Object::class.java), "findBindArgs")
                    .addStatement("this.updateSelection = updateSelection")
                    .addStatement("this.updateBindArgs = updateBindArgs")
                    .addStatement("this.insertSelection = insertSelection")
                    .addStatement("this.insertBindArgs = insertBindArgs")
                    .addStatement("this.findSelection = findSelection")
                    .addStatement("this.findBindArgs = findBindArgs")
                    .build()
            )
            .build()
    }
    ...
    private fun replacer(): TypeSpec {
        return NodeReplacerGenerator(clazz, env).typeSpec()
    }
